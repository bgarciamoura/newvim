return {
  ...
  keys = {
    ...
    { "<leader>fc", function() require("telescope.builtin").find_files() end, desc = "Find Config File" },
    ...
    { "<leader>fR", function() require("telescope.builtin").oldfiles() end, desc = "Recent (cwd)" },
    -- git
    ...
    { "<leader>sG", function() require("telescope.builtin").live_grep() end, desc = "Grep (cwd)" },
    ...
    { "<leader>sW", function() require("telescope.builtin").grep_string() end, desc = "Word (cwd)" },
    { "<leader>sw", function() require("telescope.builtin").grep_string() end, mode = "v", desc = "Selection (Root Dir)" },
    { "<leader>sW", function() require("telescope.builtin").grep_string() end, mode = "v", desc = "Selection (cwd)" },
    { "<leader>uC", function() require("telescope.builtin").colorscheme() end, desc = "Colorscheme with Preview" },
    {
      "<leader>ss",
      function()
        require("telescope.builtin").lsp_document_symbols({
          symbols = require("telescope.builtin").lsp_document_symbols,
        })
      end,
      desc = "Goto Symbol",
    },
